...
class PriceData:
    ...
    def _get_price_pionex(
        ...
        """Retrieve the price from the Pionex public market API."""
    ...
    def _get_price_bitunix(
        ...
        """Retrieve the price from the Bitunix public market API."""
        ...
        try:
            ...
            if e.response is not None and e.response.status_code == 403:
                ...
                return self._get_price_binance(
                    base_asset,
                    utc_time,
                    quote_asset,
        ...
        if price == 0:
            if not swapped_symbols:
                ...
                return self._get_price_bitunix(
                    base_asset,
                    utc_time,
                    quote_asset,
                    swapped_symbols=True,
